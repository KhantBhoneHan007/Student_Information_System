                  ...
                  <tbody>
                     @foreach ($teachers as $teacher)
                        <tr
                           ...
                           <td class="px-6 py-4 w-[120px]">
                              {{ \Carbon\Carbon::parse($teacher->updated_at)->format('y-m-d') }}
                           </td>
                           <td class="flex px-6 py-4 justify-center whitespace-nowrap">
                              <button type="button" data-modal-target="edit_model_{{ $teacher->id }}"
                                 data-modal-toggle="edit_model_{{ $teacher->id }}"
                              ...
                              <button type="button" data-modal-target="view_model_{{ $teacher->id }}"
                                 data-modal-toggle="view_model_{{ $teacher->id }}"
                           ...
                           <!-- edit modal -->
                           <div id="edit_model_{{ $teacher->id }}" tabindex="-1" aria-hidden="true"
                                 ...
                                 <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                       ...
                                       <button type="button"
                                          ...
                                          data-modal-hide="edit_model_{{ $teacher->id }}">
                                    ...
                                    <div class="p-4 md:p-5">
                                       <form class="space-y-4" method="POST"
                                          action="{{ route('teachers.update', ['teacher' => $teacher->id]) }}">
                                          @csrf
                                          @method('PUT')

                                          <div>
                                             <label
                                                for="name"class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Teacher
                                                Name</label>
                                                ...
                                                @foreach ($classrooms as $classroom)
                                                   <div class="form-check">
                                                      <input
                                                         ...
                                                         type="checkbox"
                                                         id="classroom_{{ $classroom->name }}"
                                                         name="classrooms[]" value="{{ $classroom->name }}"
                                                         @if (in_array($classroom->id, old('classrooms', explode(',', $teacher->classrooms)))) checked @endif>
                                                      {{ $classroom->name }}
                                                      </label>
                                                   </div>
                                                @endforeach
                                                ...
                                                @foreach ($certifications as $certification)
                                                   <div class="form-check">
                                                      <input
                                                         class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 "
                                                         type="checkbox"
                                                         id="certification_{{ $certification->name }}"
                                                         name="certifications[]" value="{{ $certification->name }}"
                                                         @if (in_array($certification->id, old('certifications', explode(',', $teacher->certifications)))) checked @endif>
                                                      {{ $certification->name }}
                                                      </label>
                                                   </div>
                                                @endforeach
                                          ...
                                          <div class="mt-4">
                                             ...
                                             <input type="text" name="specialist" id="specialist"
                                                value="{{ old('specialist', $teacher->specialist) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                required>
                                          </div>
                           ...
                           <!-- View modal -->
                           <div id="view_model_{{ $teacher->id }}" tabindex="-1" aria-hidden="true"
                              class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                              <div class="relative p-4 w-full max-w-2xl max-h-full">
                                 ...
                                 <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                       ...
                                       <button type="button"
                                          class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                          data-modal-hide="view_model_{{ $teacher->id }}">
                                          <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                             fill="none" viewBox="0 0 14 14">
                                             <path stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="p-6 md:p-8">
                                       ...
                                       <p class="mb-4"><strong>Name:</strong> {{ $teacher->name }}</p>
                                       <p class="mb-4"><strong>Email:</strong> {{ $teacher->email }}</p>
                                       <p class="mb-4"><strong>Phone:</strong> {{ $teacher->phone }}</p>
                                       <p class="mb-4"><strong>Gender:</strong> {{ $teacher->gender }}</p>
                                       <p class="mb-4"><strong>Age:</strong> {{ $teacher->age }}</p>
                                       <p class="mb-4"><strong>Classrooms:</strong> {{ $teacher->classrooms }}</p>
                                       <p class="mb-4"><strong>Certifications:</strong>
                                          {{ $teacher->certifications }}</p>
                                       <p class="mb-4"><strong>Specialist:</strong> {{ $teacher->specialist }}</p>
                                       <p class="mb-4"><strong>Designation:</strong> {{ $teacher->designation }}</p>
                                    </div>
                                 </div>
                              </div>
                           </div>
   ...
   <div id="create_model" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
         ...
         <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5">
               <form class="space-y-4" method="POST" action="{{ route('teachers.store') }}">
                  @csrf
                  <div>
                     <label for="name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Teacher Name</label>
                     <input type="name" name="name" id="name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        required>
                  </div>
                     ...
                     <div class="mb-3">
                        ...
                        @foreach ($classrooms as $classroom)
                           <div class="form-check">
                              <input type="checkbox"
                                 class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                 type="checkbox" id="classroom{{ $classroom->name }}" name="classrooms[]"
                     ...
                     <div class="mb-3">
                        ...
                        @foreach ($certifications as $certification)
                           <div class="form-check">
                              <input type="checkbox"
                                 class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                 type="checkbox" id="certification_{{ $certification->name }}"
                                 name="certifications[]" value="{{ $certification->name }}">
                              <label class="form-check-label" for="certification_{{ $certification->id }}">
                                 {{ $certification->name }}
                              </label>
                           </div>
                        @endforeach

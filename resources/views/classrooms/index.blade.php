                     ...
                     @foreach ($classrooms as $classroom)
                        <tr
                           ...
                           <td class="px-6 py-4 w-[120px]">
                              {{ \Carbon\Carbon::parse($classroom->created_at)->format('y-m-d') }}
                           </td>
                           <td class="px-6 py-4 w-[120px]">
                              {{ \Carbon\Carbon::parse($classroom->updated_at)->format('y-m-d') }}
                           </td>
                           <td class="flex px-6 py-4 justify-center whitespace-nowrap">
                              <button type="button" data-modal-target="edit_model_{{ $classroom->id }}"
                                 data-modal-toggle="edit_model_{{ $classroom->id }}"
                           ...
                           <!-- edit modal -->
                           <div id="edit_model_{{ $classroom->id }}" tabindex="-1" aria-hidden="true"
                                 ...
                                 <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                       ...
                                       <button type="button"
                                          ...
                                          data-modal-hide="edit_model_{{ $classroom->id }}">
                                    ...
                                    <div class="p-4 md:p-5">
                                       <form class="space-y-4" method="POST"
                                          action="{{ route('classrooms.update', ['classroom' => $classroom->id]) }}">
                                          @csrf
                                          @method('PUT')

                                          <div>
                                             <label for="name"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Classroom
                                                Name</label>
   ...
   <div id="create_model" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
         ...
         <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5">
               <form class="space-y-4" method="POST" action="{{ route('classrooms.store') }}">
                  @csrf
                  <div>
                     <label for="name"
